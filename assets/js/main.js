(function ($) {
	...
	function tg_theme_toggler() {
		...
		function tg_init_theme() {
			if (localStorage.getItem('tg_theme_scheme') === 'dark') {
				...
				if (document.querySelector('.modeSwitch')) {
	...
	if ($('.brand-active').length) {
		$('.brand-active').slick({
			...
			responsive: [
				...
				{ breakpoint: 767, settings: { slidesToShow: 3, slidesToScroll: 1, arrows: false } },
				{ breakpoint: 575, settings: { slidesToShow: 2, slidesToScroll: 1, arrows: false } }
			]
		});
	}
	...
	/*=============================================
      =    		Featured Active
    =============================================*/
	if ($('.featured-post-active').length) {
	...
	if ($('.editor-post-active-two').length) {
	...
	/*=============================================
      =    		Trending Active
    =============================================*/
	if ($('.trending-post-active').length) {
	...
	if ($('.coin-active').length) {
		$('.coin-active').slick({
			...
			slidesToScroll: 2,
			responsive: [
				{ breakpoint: 1200, settings: { slidesToShow: 5, slidesToScroll: 2, infinite: true } },
				{ breakpoint: 992, settings: { slidesToShow: 4, slidesToScroll: 1 } },
				{ breakpoint: 767, settings: { slidesToShow: 3, slidesToScroll: 1, arrows: false } },
				{ breakpoint: 575, settings: { slidesToShow: 2, slidesToScroll: 1, arrows: false } }
			]
	...
	/*=============================================
      =    		Trending Slider
    =============================================*/
	if ($(".ta-trending-slider").length) {
		new Swiper(".ta-trending-slider", {
			slidesPerView: 1,
			loop: true,
